...
func (s *BookService) CreateBook(userID, name, description string) (*postgres.Book, error) {
	// TODO Добавить валидацию и бизнес логику
	return s.storage.CreateBook(userID, name, description)
}

func (s *BookService) GetUserBooks(userID string) ([]*postgres.Book, error) {
	// TODO Добавить валидацию и бизнес логику
	return s.storage.GetUserBooks(userID)
}

func (s *BookService) UpdateBookStatus(bookID, status string) (*postgres.Book, error) {
	// TODO Добавить валидацию и бизнес логику
...
func (s *BookService) UpdateBookRating(bookID string, rating float64) (*postgres.Book, error) {
	// TODO Добавить валидацию и бизнес логику
...
func (s *BookService) GetBook(bookID string) (*postgres.Book, error) {
	// TODO Добавить валидацию и бизнес логику
	return s.storage.GetBook(bookID)
}
